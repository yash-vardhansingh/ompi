...
#define PMIX_CONFIGURE_CLI " \'--disable-option-checking\' \'--prefix=/mnt/d/Git_Hub_test/ompi/openmpi\' \'--without-tests-examples\' \'--enable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--disable-devel-check\' \'--cache-file=/dev/null\' \'--srcdir=.\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "Wed Sep 11 05:46:08 UTC 2024"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "MSI"

/* User who built PMIx */
#define PMIX_CONFIGURE_USER "yash"
...
#define PMIX_PACKAGE_STRING "PMIx yash@MSI Distribution"
